...
data.agenda = [
    ...
    {time: '11:15-12:30', topic: speakerToDescription(data.speakers[1]), speaker: speaker(data.speakers[1])},
    {time: '12:30-12:45', description: 'Кава'},
    {time: '12:45-14:00', topic: speakerToDescription(data.speakers[2]), speaker: speaker(data.speakers[2])},
    {time: '14:00-14:15', description: 'Напої та снеки'},
    {time: '14:15-15:30', topic: speakerToDescription(data.speakers[0]), speaker: speaker(data.speakers[0])},
